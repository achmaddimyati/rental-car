                ...
                @foreach ($cars as $car)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Sale badge-->
                            <div class="badge badge-custom {{ $car->status == 'tersedia' ? 'bg-success' : 'bg-warning' }}bg-warning text-white position-absolute"
                                style="top: 0; right: 0">
                                {{ $car->status }}
                            </div>
                            <!-- Product image-->
                            ...
                            <div class="card-body card-body-custom pt-4">
                                <div class="text-center">
                                    ...
                                    <div class="rent-price mb-3">
                                        <span class="text-primary">Rp.{{ number_format($car->harga_mobil) }}/</span>day
                                    </div>
